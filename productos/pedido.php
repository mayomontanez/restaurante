    ...
    -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li id="6">
                    <a href="productos.php?idmesa=<?php echo $idmesa;?>&alertaCuenta=true">
                        <i class="pe-7s-news-paper"></i> 
                        <p>PEDIR CUENTA</p>
                    </a>        
                </li>
                <li id="7">
                    <a href="productos.php?idmesa=<?php echo $idmesa;?>&alertaAyuda=true">
                ...
                <div class="row">                   
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content table-responsive table-full-width" id='contenido' name="<?php echo $idmesa;?>">
                                <!--
